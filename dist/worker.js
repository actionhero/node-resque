...
class Worker extends events_1.EventEmitter {
    ...
    async end() {
        ...
        if (this.connection && (this.connection.connected === true || this.connection.connected === undefined || this.connection.connected === null)) {
    ...
    async workingOn(job) {
        return this.connection.redis.set(this.connection.key('worker', this.name, this.stringQueues()), JSON.stringify({
