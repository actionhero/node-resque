...
connection.prototype.connect = function(callback){
  ...
  if(options.password && options.password !== '' && self.options.fake !== true){
  ...
  if(self.options.package === 'fakeredis' || ( self.options.redis && self.options.redis.connected === true )){
    if(options.database){ self.redis.select(options.database); }
